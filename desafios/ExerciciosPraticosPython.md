# Exercícios Práticos Python (A Resolução Completa com Entrega Vale 1,0 na AV2)
...
- Dentro de cada nível, existem diversas categorias de exercícios para você praticar seus conhecimentos.
